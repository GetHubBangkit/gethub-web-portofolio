...
export default function Home() {
    return (
      <div>
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-cyan-400 to-light-blue-500 py-20 text-white">
        ...
        <section className="py-20 bg-gray-900 text-white text-center">
          ...
          <a href="/signup" className="bg-cyan-400 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-cyan-600 transition duration-300">Get Application</a>
        </section>
      </div>
    );
  }
