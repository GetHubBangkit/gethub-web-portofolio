...
const ProductCard = ({ product }) => (
  <div className='w-44 inline-block h-auto cursor-pointer hover:scale-105 p-2 ease-in-out duration-300 '>
    ...
    <h1 className='mt-4 font-bold text-xs text-[#F08A8A]'>Rp. {product.price}</h1>
  ...
  const ButtonLink = ({ links }) => (
    <a href={ links.link }>
      <button className=' bg-[#FFD7D7] text-white  w-80 h-[52px] rounded-3xl flex justify-center items-center shadow'>
        <img src={
  ...
  return (  
    ...
    <div className="flex justify-center h-auto">
      <div className='h-auto flex flex-col items-center px-4 lg:p-0' style={{ width: '430px' }}>
        ...
        {/* social media */}
        <div className='flex justify-start flex-col items-start w-full pb-6 mt-[-120px]'>
